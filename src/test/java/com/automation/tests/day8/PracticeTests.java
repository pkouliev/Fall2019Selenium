...
public class PracticeTests {
    ...
    public void loginTest() {
        ...
        Assert.assertEquals(actual, expected, "Subheader message is not matching!");
    }

    /**
     * Given user is on the practice landing page
     * When user navigates to "Forget password" page
     * Then user enters his or her email
     * And clicks "Retrieve password" button
     * Then user verifies that message "Your e-mail has been sent!" is displayed
     */
    @Test
    public void forgotPassword() {
        ...
        driver.findElement(By.name("email")).sendKeys("testemail@rmail.com", Keys.ENTER);
        BrowserUtils.wait(3);

        String actual = driver.findElement(By.name("conformation_message")).getText();
        String expected = "Your e-mail's been send!";
