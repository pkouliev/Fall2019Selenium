...
//    CalendarEventsPage calendarEventsPage = new CalendarEventsPage();
    ...
    public void defaultOptionsTest() {
        ...
        String expectedStartDate = DateTimeUtilities.getCurrentDate(LocalDate.now());

        Assert.assertEquals(actualStartDate, expectedStartDate);

        test.pass("Default login options verified");
    ...
    public void timeDifferenceTest() {
        ...
        String format = "h:mm a"; // 5:15 AM for example
    ...
    public void verifyColumnNamesTest() {
        ...
        test.pass("ColumnNames are verified");
    }

    //  public Object[] event

    @Test(dataProvider = "calendarEvents")
    public void createCalandarEventTest(String title, String description) {
        //if you have more than one test, and 1st pass other failing,
        //you are getting session id is null exception
        //because driver object was not initialized on time
        //just create test objects
        LoginPage loginPage = new LoginPage();
        CalendarEventsPage calendarEventsPage = new CalendarEventsPage();
